                 ...
                 <div className="outerr-input-block">
                      <div className="innerr-input-blocks">
                          ...
                          <div className="first-name-block blocks">
                             <InputControl label="FIRST NAME" className="inputt" onChange={(event) => 
                             setValues((prev) => ({...prev, firstname: event.target.value}))
                             }/>
                          </div>  

                          <div className="last-name-block blocks">
                             <InputControl label="LAST NAME" className="inputt" onChange={(event) => 
                             setValues((prev) => ({...prev, lastname: event.target.value}))
                             }/>
                          </div>  

                          <div className="emaill-block blocks">
                             <InputControl label="EMAIL" className="inputt" onChange={(event) => 
                             setValues((prev) => ({...prev, email: event.target.value}))
                             }/>
                          </div>  

                          <div className="password-block blocks">
                             <InputControl label="PASSWORD" className="inputt" onChange={(event) => 
                         ...
                         <button className='create-btn' onClick={handleSubmission} disabled={submitButtonDisabled}>CREATE</button> 
                          </div>
